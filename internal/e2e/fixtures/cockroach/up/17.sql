...
CREATE TABLE public.e2e_token (
	...
	iat TIMESTAMP NOT NULL DEFAULT '2000-01-01 00:00:00':::TIMESTAMP,
	e2e_flow_id UUID NULL,
	flow_id UUID NULL,
	expires_at TIMESTAMP NOT NULL DEFAULT '2002-01-01 00:00:00':::TIMESTAMP,
	CONSTRAINT "primary" PRIMARY KEY (id ASC),
	UNIQUE INDEX e2e_token_uq_idx (token ASC),
	INDEX e2e_token_idx (token ASC),
	FAMILY "primary" (id, token, e2e_address_id, iat, e2e_flow_id, flow_id, expires_at)
);
-- # row 7
-- ## 156
