...
CREATE TABLE IF NOT EXISTS "e2e_tokens" (
"id" TEXT PRIMARY KEY,
"token" TEXT NOT NULL,
"e2e_flow_id" char(36),
...
FOREIGN KEY (flow_id) REFERENCES e2e_flow (id) ON UPDATE NO ACTION ON DELETE RESTRICT
);
CREATE UNIQUE INDEX "e2e_token_uq_idx" ON "e2e_tokens" (token);
CREATE INDEX "e2e_token_idx" ON "e2e_tokens" (token);
