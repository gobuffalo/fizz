...
--
-- Name: e2e_tokens; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.e2e_tokens (
    id uuid NOT NULL,
    token character varying(64) NOT NULL,
    e2e_flow_id uuid,
    e2e_address_id uuid NOT NULL,
    expires_at timestamp without time zone DEFAULT '2003-01-01 00:00:00'::timestamp without time zone NOT NULL,
    iat timestamp without time zone DEFAULT '2000-01-01 00:00:00'::timestamp without time zone NOT NULL,
    flow_id uuid
);


ALTER TABLE public.e2e_tokens OWNER TO postgres;
...
--
-- Name: e2e_tokens e2e_token_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.e2e_tokens
...
CREATE INDEX e2e_token_idx ON public.e2e_tokens USING btree (token);
...
CREATE UNIQUE INDEX e2e_token_uq_idx ON public.e2e_tokens USING btree (token);
...
--
-- Name: e2e_tokens e2e_token_e2e_address_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: e2e_tokens e2e_token_e2e_flow_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: e2e_tokens e2e_token_flow_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.e2e_tokens
    ADD CONSTRAINT e2e_token_flow_id_fk FOREIGN KEY (flow_id) REFERENCES public.e2e_flow(id) ON DELETE RESTRICT;
