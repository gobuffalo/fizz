...
CREATE TABLE public.e2e_token (
    ...
    expires_at timestamp without time zone DEFAULT '2002-01-01 00:00:00'::timestamp without time zone NOT NULL,
...
--
-- Name: e2e_token e2e_token_flow_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
